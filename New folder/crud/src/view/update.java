...
public class update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/update.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean bb = Service.UpdateService.update(name, address, roll, phone_no);
        String rr = Service.UpdateService.roll1;
        if(bb)
        {
            if(roll.equals(rr))
            {
